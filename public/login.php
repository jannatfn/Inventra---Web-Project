...
<body class="d-flex align-items-center justify-content-center p-3" style="min-height: 100vh; background-color: var(--bg-deep);">
    ...
    <div class="card p-4 p-lg-5 animate-fade shadow-lg" style="width: 100%; max-width: 480px;">
        <div class="text-center mb-5">
            <div class="mb-3 d-flex align-items-center justify-content-center text-primary fs-1 fw-extrabold">
                <i class="bi bi-box-seam-fill me-3"></i> Inventra
            </div>
            <h2 class="fw-extrabold m-0">Welcome Back</h2>
            <p class="text-dim mt-2">Please sign in to manage inventory.</p>
        </div>
        ...
        <form id="loginForm">
            ...
            <div class="mb-5">
                <div class="d-flex justify-content-between mb-2">
                    <label class="form-label small fw-bold text-dim uppercase tracking-wider m-0">Password</label>
                    <a href="#" class="text-accent text-decoration-none small fw-bold">Forgot?</a>
                </div>
        ...
        <div class="text-center mt-5">
            ...
            <a href="register.php" class="text-accent text-decoration-none fw-bold ms-1">Sign up</a>
        </div>
    </div>
